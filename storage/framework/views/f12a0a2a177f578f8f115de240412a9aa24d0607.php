...
<div class="rpd-dataform">
    ...
    <?php $__env->startSection('df.footer'); ?>
        <?php echo $__env->make('rapyd::toolbar', array('buttons_left'=>$df->button_container['BL'], 'buttons_right'=>$df->button_container['BR'], 'buttons_center'=>$df->button_container['BC'] ), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php echo $df->close; ?>
