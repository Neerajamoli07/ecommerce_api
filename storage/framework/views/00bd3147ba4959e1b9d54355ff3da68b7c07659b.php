...
<ul class="navmenu center">
    <li class="normal menu"><a href="<?php echo e(url('cms')); ?>"><?php echo app('translator')->getFromJson('site.home'); ?></a>
        <!-- MEGA MENU -->
    </li>
    <!-- //MEGA MENU -->
    <!-- MEGA MENU-->
...
<!-- //MEGA MENU -->
    <!-- MEGA MENU -->
    <li class=" normal menu"><a href="<?php echo e(url('blog')); ?>"><?php echo app('translator')->getFromJson('site.blog'); ?></a></li>
    <!-- //MEGA MENU -->
    ...
    <li class="sub-menu"><a><?php echo e($locale); ?></a>
        <ul class="mega_menu megamenu_col1 clearfix">
            <li class="col">
                ...
                <ol><li><a href="<?php echo e(url('locale')); ?>/bg">bg</a></li></ol>
            </li>
        </ul>
    </li>
</ul>
